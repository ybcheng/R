...
# the script will plot satellite imagery, EM (if available, otherwise a dummy img) on top half
...
# example output: IID_Task3c_Plot_Sat_EM_Photo_ASD_avg60_YBC.pdf
...
#Photo_Folder = "K:/IID_SaltonSea/Tasks/Task3b/Tasks/PhotoDocumentation/Final"
...
SavePDF = "C:/Users/ybcheng/Documents/R/SaltonSea/examples_plotting/IID_Task3c_Plot_Sat_EM_Photo_ASD_avg60_YBC.pdf"
...
for (jpgfile in FEIDjpg_Unique) {
  ...
  avg_subset <- data.frame(x=iData2_subset2$Z, sand=iData2_subset2$avg_sand, silt=iData2_subset2$avg_silt, clay=iData2_subset2$avg_clay, fine=iData2_subset2$avg_fine) #, water=iData2_subset2$avg_water)
