...
#fd <- "E:/DCIM/103D800E"
#fd <- "//CPDS/Form/Task3c/PhotoStation/20171018"
fd <- "K:/IID_SaltonSea/Tasks/Soil mapping/PhotoDocumentation/Original/20190115"
file_pattern <- "\\.JPG$"
files_per_core <- 28
...
# EDIT the following parameters
#fd <- "//CPDS/Form/Task3c/PhotoStation/20171018"
fd <- "K:/IID_SaltonSea/Tasks/PotentialPilotStudies/Clubhouse/PhotoDocumentation/Original/20180225"
...
# EDIT the following parameters
fd <- "X:/Task3c/PhotoStation/20171018"
file_pattern <- "_SL.jpg$"
out_csv <- "filelist.txt"

td <- "k:/IID_SaltonSea/Tasks/Task3e_VailDrainFSPS/PhotoDocumentation/Processing/"
